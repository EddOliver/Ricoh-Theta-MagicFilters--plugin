...
public final class Constants {
    ...
    public static final String PLUGIN_DIRECTORY = DCIM + "/Filtered Images";
    ...
    public static final int PREVIEW_SIZE_WIDTH = 5376;
    public static final int PREVIEW_SIZE_HEIGHT = 2688;
